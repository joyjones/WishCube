...
namespace OpenCVForUnityExample
{
    ...
    public class ArUcoWebCamTextureExample : MonoBehaviour
    {
        ...
        public void OnWebCamTextureToMatHelperInitialized ()
        {
			...
			Debug.Log ("scaleW " + widthScale + " scaleH " + heightScale);
        ...
        void Update ()
        {
            ...
            if (webCamTextureToMatHelper.IsPlaying () && webCamTextureToMatHelper.DidUpdateThisFrame ()) {
				...
				if (ids.total () > 0 && debugUI != null) {
					...
					Vector3 center = new Vector3(tcx / 4.0f - texture.width * 0.5f, tcy / 4.0f - texture.height * 0.5f, 0);
					debugUI.GetComponent<UnityEngine.UI.Text> ().text = string.Format ("Center: {0}, {1}", center.x, center.y);
				}
