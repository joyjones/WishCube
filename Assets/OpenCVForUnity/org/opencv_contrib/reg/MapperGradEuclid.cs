...
namespace OpenCVForUnity
{
    ...
    public class MapperGradEuclid : Mapper
    {
        ...
        public override Map calculate (Mat img1, Mat img2, Map init)
        {
            ...
            Map retVal = new Map (reg_MapperGradEuclid_calculate_10 (nativeObj, img1.nativeObj, img2.nativeObj, init.getNativeObjAddr ()));
        ...
        public override Map calculate (Mat img1, Mat img2)
        {
            ...
            Map retVal = new Map (reg_MapperGradEuclid_calculate_11 (nativeObj, img1.nativeObj, img2.nativeObj));
        ...
        public override Map getMap ()
        {
            ...
            Map retVal = new Map (reg_MapperGradEuclid_getMap_10 (nativeObj));
